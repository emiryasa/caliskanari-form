            ...
            <motion.div key={item.title} className="hoverable-div">
              <div className="flex items-center gap-4 py-5 px-8 info-section-icons">
                ...
                <span className="flex flex-col gap-2">
                  {index === 0 && <p className={`text-xl ${textColor}`}>{infoSection[0]?.text}</p>}
                  {index === 0 && <p className="text-base text-lightgrey">{infoSection[1]?.text}</p>}
                  {index === 1 && <p className={`text-xl ${textColor}`}>{infoSection[2]?.text}</p>}
                  {index === 1 && <p className="text-base text-lightgrey">{infoSection[3]?.text}</p>}
                  {index === 2 && <p className={`text-xl ${textColor}`}>{infoSection[4]?.text}</p>}
                  {index === 2 && <p className="text-base text-lightgrey">{infoSection[5]?.text}</p>}
                </span>
              </div>
            </motion.div>
          );
...
//         <motion.div key={index} className="hoverable-div">
//           <div className="flex items-center gap-4 py-5 px-8 info-section-icons">
//             <motion.span className={`text-4xl ${item.color}  `}>
//               {item.icon && <item.icon />}
//             </motion.span>
